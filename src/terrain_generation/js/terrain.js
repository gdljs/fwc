...
// Taken from https://github.com/hunterloftis/playfuljs-demos/blob/gh-pages/terrain/index.html
// With some minor changes to code style
var Terrain = function Terrain(detail) {
...
Terrain.prototype = {
  ...
  set: function set(x, y, val) {
    this.map[x + this.size * y] = val;
  },
  generate: function generate(roughness) {
    var self = this;
...
Object.defineProperty(Terrain.prototype, 'constructor', {value: Terrain});
